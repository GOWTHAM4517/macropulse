...
/**
 * Live 24K gold price, sourced from gold-api.com (free, no key, no rate limit).
...
public class GoldService {
    ...
    public GoldService(CurrencyService currencyService) {
    ...
    public GoldPrice getGoldPrice() {
        ...
        GoldPrice result = new GoldPrice("Gold", "24K", round2(price), "INR");
    ...
    private void refresh(long now) {
        try {
            ...
            Map<?, ?> response = restTemplate.getForObject(GOLD_URL, Map.class);
